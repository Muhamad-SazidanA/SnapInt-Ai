...
// Newsroom page – placeholder matching design pattern (Images 4)
        ...
        <div className="bg-white text-gray-900">
            <section>
                <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-24 text-center">
                    ...
                    <h1 className="text-4xl sm:text-5xl font-extrabold tracking-tight text-black">Newsroom</h1>
                    <p className="mt-4 text-lg text-slate-600">Latest news, press releases, and media coverage</p>
