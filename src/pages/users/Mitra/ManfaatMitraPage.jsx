...
// Partner Benefits page – placeholder matching design pattern
export default function ManfaatMitraPage() {
    return (
        <div className="bg-white text-gray-900">
            <section>
                <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-24 text-center">
                    ...
                    <h1 className="text-4xl sm:text-5xl font-extrabold tracking-tight text-black">Partner Benefits</h1>
                    <p className="mt-4 text-lg text-slate-600">Benefits and advantages of partnering with us</p>
